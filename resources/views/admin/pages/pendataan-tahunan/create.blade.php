        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Halaman Tambah Pendataan Tahunan</h3>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('admin.pendataan.store') }}" method="POST" enctype="multipart/form-data" class="form form-vertical">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" class="form-control" name="judul" value="{{ old('judul') }}" placeholder="Judul pendataan tahunan..">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="first-name-vertical">Batas Tanggal Pendataan</label>
                                                    <input name="batas_tanggal" value="{{ old('batas_tanggal') }}" type="date" class="form-control mb-3 flatpickr-no-config" placeholder="Select date..">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
