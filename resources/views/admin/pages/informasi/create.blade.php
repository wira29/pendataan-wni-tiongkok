                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" class="form-control" name="judul" placeholder="Judul">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="email-id-vertical">Deskripsi</label>
                                                    <textarea class="form-control" name="deskripsi" id="deskripsi" cols="5" rows="5" placeholder="deskripsi..."></textarea>
                                                </div>
                                            </div>
