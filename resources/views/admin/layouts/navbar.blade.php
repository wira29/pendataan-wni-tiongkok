...
{{--                    </li>--}}
                ...
                <div class="dropdown">
                        ...
                        <div class="user-menu d-flex">
                            ...
                            <div class="user-img d-flex align-items-center">
                                <div class="avatar avatar-md">
                                    <img src="{{ ($user->foto) ? asset('storage/' . $user->foto) : asset('assets/compiled/jpg/1.jpg') }}">
                                </div>
                            </div>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                        ...
                        <li><a class="dropdown-item" href="{{route('admin.profile.index')}}"><i class="icon-mid bi bi-person me-2"></i> Profil</a></li>
                        <li>
